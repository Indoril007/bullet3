...
class ModifiedHalfCheetah(WalkerBase):
	foot_list = ["ffoot", "fshin", "fthigh",  "bfoot", "bshin", "bthigh"]  # track these contacts with ground

	def __init__(self, i):
		WalkerBase.__init__(self, "modified_half_cheetahs/modified_half_cheetah_{}.xml".format(i), "torso", action_dim=6, obs_dim=26, power=0.90)
...
class DisabledHalfCheetah(WalkerBase):
	foot_list = ["ffoot", "fshin", "fthigh",  "bfoot", "bshin", "bthigh"]  # track these contacts with ground

	def __init__(self, i):
		WalkerBase.__init__(self, "joint_disabled_half_cheetahs/disabled_half_cheetah_{}.xml".format(i), "torso", action_dim=6, obs_dim=26, power=0.90)
...
class ModifiedAnt(WalkerBase):
	...
	def __init__(self, i):
		WalkerBase.__init__(self, "modified_ants/ant_{}.xml".format(i), "torso", action_dim=8, obs_dim=28, power=2.5)
...
class ModifiedHumanoid(WalkerBase):
	self_collision = True
	foot_list = ["right_foot", "left_foot"]  # "left_hand", "right_hand"

	def __init__(self, i=0):
		WalkerBase.__init__(self,  'modified_humanoids/humanoid_symmetric_{}.xml'.format(i), 'torso', action_dim=17, obs_dim=44, power=0.41)
		# 17 joints, 4 of them important for walking (hip, knee), others may as well be turned off, 17/4 = 4.25
...
class DisabledHumanoid(WalkerBase):
	self_collision = True
	foot_list = ["right_foot", "left_foot"]  # "left_hand", "right_hand"

	def __init__(self, i=0):
		WalkerBase.__init__(self,  'disabled_humanoid/humanoid_symmetric_{}.xml'.format(i), 'torso', action_dim=17, obs_dim=44, power=0.41)
		# 17 joints, 4 of them important for walking (hip, knee), others may as well be turned off, 17/4 = 4.25
